...
CREATE TABLE `users` (
  ...
  `telegram_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `search_index` (`email`,`password`)
...
INSERT INTO `users` VALUES (1,'Muhammet','go.suits.3@gmail.com','905069265003',NULL,'ed4859ec7e340418d80750653e3cb896',NULL,NULL,'4a171330329f5a795a240b4777b8be7c','2023-05-16 19:52:00','2023-05-16 19:59:29');
...
-- Dump completed on 2023-05-16 20:34:22
